#############################################################################
# Makefile for building: hid
# Generated by qmake (2.01a) (Qt 4.8.4) on: ?? ?? 24 10:48:44 2016
# Project:  src\hid-can-normal.pro
# Template: app
# Command: c:\Qt\4.8.4\bin\qmake.exe -spec c:\Qt\4.8.4\mkspecs\win32-g++ CONFIG+=declarative_debug -o Makefile src\hid-can-normal.pro
#############################################################################
...
Makefile: src/hid-can-normal.pro  c:/Qt/4.8.4/mkspecs/win32-g++/qmake.conf c:/Qt/4.8.4/mkspecs/features/device_config.prf \
	...
	$(QMAKE) -spec c:\Qt\4.8.4\mkspecs\win32-g++ CONFIG+=declarative_debug -o Makefile src\hid-can-normal.pro
